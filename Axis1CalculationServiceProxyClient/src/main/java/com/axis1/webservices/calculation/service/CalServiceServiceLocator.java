...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.axis1.webservices.calculation.service.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8080/Axis1CalculationService/services/CalService";
    ...
    public com.axis1.webservices.calculation.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.axis1.webservices.calculation.service.CalServiceSoapBindingStub _stub = new com.axis1.webservices.calculation.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.axis1.webservices.calculation.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.axis1.webservices.calculation.service.CalServiceSoapBindingStub _stub = new com.axis1.webservices.calculation.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.calculation.webservices.axis1.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.calculation.webservices.axis1.com", "CalService"));
        }
